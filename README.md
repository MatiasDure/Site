...
- **Spotify integration** — Recently played track via the Spotify Web API (refresh-token flow).
...
| `SPOTIFY_REFRESH_TOKEN` | OAuth2 refresh token with `user-read-recently-played` scope |
